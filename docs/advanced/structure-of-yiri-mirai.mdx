...
模型层的模块全部定义于 [`mirai.models`](https://yiri-mirai-api.vercel.app/models/index.html) 命名空间中。
...
模型事件总线。模型事件总线拓展了事件总线的功能，使之可以使用 [`mirai.models.events`](https://yiri-mirai-api.vercel.app/models/events.html) 中定义的事件类型来注册和接收事件。
